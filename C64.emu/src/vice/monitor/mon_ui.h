...
extern uint16_t mon_navigate_scroll(mon_navigate_private_t *,
                                MON_SCROLL_TYPE );
extern uint16_t mon_navigate_scroll_to(mon_navigate_private_t *, uint16_t);
...
extern void mon_disassembly_determine_popup_commands(mon_disassembly_private_t *, int xPos, int yPos, uint16_t *ulMask, uint16_t *ulDefault);
...
extern void mon_navigate_goto_address(mon_navigate_private_t *, uint16_t addr);
extern void mon_navigate_goto_pc(mon_navigate_private_t *);
extern uint16_t mon_navigate_get_startaddress(mon_navigate_private_t *mnp);
extern void mon_navigate_set_startaddress(mon_navigate_private_t *mnp, uint16_t StartAddress);
