...
extern void comal80_config_setup(uint8_t *rawcart);
extern int comal80_bin_attach(const char *filename, uint8_t *rawcart);
extern int comal80_crt_attach(FILE *fd, uint8_t *rawcart);
