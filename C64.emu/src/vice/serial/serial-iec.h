...
extern int serial_iec_read(unsigned int unit, unsigned int secondary, uint8_t *data);
extern int serial_iec_write(unsigned int unit, unsigned int secondary, uint8_t data);
