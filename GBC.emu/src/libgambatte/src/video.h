...
class LCD {
	...
	static void setDmgPalette(PixelType *palette, const PixelType *dmgColors, unsigned data);
...
public:
	...
	void setVideoBuffer(PixelType *videoBuf, int pitch);
