...
public:
	...
	static SysDDec gain(unsigned div) { return rshift16_round(-32768l * (div * div * div) * mulForDiv(div)) / -32768.0; }
};
...
public:
	...
	static SysDDec gain(unsigned div) { return Cic3Core<channels>::gain(div); }
};
