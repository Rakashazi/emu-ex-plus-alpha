...
class BlackmanSinc : public SubResampler {
	...
	static SysDDec blackmanWin(const long i, const long M) {
...
public:
	...
	BlackmanSinc(unsigned div, unsigned phaseLen, SysDDec fc) { init(div, phaseLen, fc); }
...
template<unsigned channels, unsigned phases>
void BlackmanSinc<channels, phases>::init(const unsigned div, const unsigned phaseLen, const SysDDec fc) {
