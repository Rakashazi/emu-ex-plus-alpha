...
public:
	...
	Kaiser70Sinc(unsigned div, unsigned phaseLen, SysDDec fc) { init(div, phaseLen, fc); }
...
template<unsigned channels, unsigned phases>
void Kaiser70Sinc<channels, phases>::init(const unsigned div, const unsigned phaseLen, const SysDDec fc) {
