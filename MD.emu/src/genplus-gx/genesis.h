...
/* Global variables */
extern uint8 tmss[4] __attribute__ ((aligned (4)));
extern uint8 bios_rom[0x800] __attribute__ ((aligned (4)));
extern uint8 work_ram[0x10000] __attribute__ ((aligned (4)));
extern uint8 zram[0x2000] __attribute__ ((aligned (4)));
extern uint32 zbank;
extern uint8 zstate;
extern uint8 pico_current;
extern uint8 pico_page[7] __attribute__ ((aligned (4)));
