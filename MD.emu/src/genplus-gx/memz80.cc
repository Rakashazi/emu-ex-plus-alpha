...
unsigned char z80_md_memory_r(unsigned int address)
{
  switch((address >> 13) & 7)
  {
    ...
    {
      return fm_read(Z80.cycleCount, address & 3);
    }
    ...
    default: /* $8000-$FFFF: 68k bank (32K) */
    {
      ...
      return READ_BYTE(mm68k.memory_map[slot].base, address & 0xFFFF);
    }
  }
}
...
void z80_md_memory_w(unsigned int address, unsigned char data)
{
  switch((address >> 13) & 7)
  {
    ...
    case 2: /* $4000-$5FFF: YM2612 */
    {
      fm_write(Z80.cycleCount, address & 3, data);
      return;
    }
    ...
    default: /* $8000-$FFFF: 68k bank (32K) */
    {
      ...
      WRITE_BYTE(mm68k.memory_map[slot].base, address & 0xFFFF, data);
      return;
    }
  }
}
...
void z80_sms_port_w(unsigned int port, unsigned char data)
{
  switch (port & 0xC1)
  {
    case 0x01:
    {
    	io_z80_write(1, data, Z80.cycleCount + PBC_CYCLE_OFFSET);
      return;
    }
    ...
    default:
    {
      ...
      {
        fm_write(Z80.cycleCount, port&3, data);
        return;
      }
...
unsigned char z80_sms_port_r(unsigned int port)
{
  switch (port & 0xC1)
  {
    case 0x40:
    {
      return ((vdp_hvc_r(Z80.cycleCount) >> 8) & 0xFF);
    }
    ...
    case 0x81:
    {
      return vdp_z80_ctrl_r(Z80.cycleCount);
    }
