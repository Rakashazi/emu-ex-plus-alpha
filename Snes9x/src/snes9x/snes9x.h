...
struct SSettings
{
	...
	static const int32	InterpolationMethod;
	...
	static const uint32	SuperFXClockMultiplier;
	static const int	OneClockCycle;
	static const int	OneSlowClockCycle;
	static const int	TwoClockCycles;
	static const int	MaxSpriteTilesPerLine;					   
};
