...
extern uint32 (* const*fx_ppfFunctionTable)(uint32);
extern void (* const*fx_ppfPlotTable)();
extern void (**fx_ppfOpcodeTable)();

extern uint32 (*const fx_apfFunctionTable[])(uint32);
extern void (*fx_apfOpcodeTable[])();
extern void (*const fx_apfPlotTable[])();
