...
constexpr std::array<const std::string_view, keyboardKeys> keyboardName
{
	"1",
	"2",
	"3",
...
constexpr int keyboardKeyOffset = switchKeyOffset + switchKeys;
constexpr int keyboard2KeyOffset = keyboardKeyOffset + keyboardKeys;
