...
static const int blip_sample_max = 32767;
...
private:
	...
	int bass_freq_ = 16;
	int length_ = 0;
	Blip_Buffer* modified_ = nullptr; // non-zero = true (more optimal than using bool, heh)
...
// Affects size of Blip_Synth objects since they store the waveform directly.
	...
	public:
		...
		void volume_unit( SysDecimal );
		constexpr Blip_Synth_Fast_() { };
...
public:
	...
	void volume( SysDecimal v ) { impl.volume_unit( v * (1.0 / (range < 0 ? -range : range)) ); }
...
public:
	constexpr Blip_Synth() : impl( impulses, quality ) { }
#endif
};
...
public:
	...
	blip_eq_t( SysDecimal treble_db = 0 );

	// See blip_buffer.txt
	blip_eq_t( SysDecimal treble, long rolloff_freq, long sample_rate, long cutoff_freq = 0 );
...
inline blip_eq_t::blip_eq_t( SysDecimal t ) :
		treble( t ), rolloff_freq( 0 ), sample_rate( 44100 ), cutoff_freq( 0 ) { }
inline blip_eq_t::blip_eq_t( SysDecimal t, long rf, long sr, long cf ) :
