...
void gbafilter_pal(uint16_t* buf, int count, int systemRedShift, int systemGreenShift, int systemBlueShift)
{
    short temp[3 * 3], s;
    unsigned pix;
...
void gbafilter_pal32(uint32_t* buf, int count, int systemRedShift, int systemGreenShift, int systemBlueShift)
{
    short temp[3 * 3], s;
    unsigned pix;
    uint8_t red, green, blue;
...
void gbafilter_pad(uint8_t* buf, int count, int systemRedShift, int systemGreenShift, int systemBlueShift)
{
    union {
        struct
        {
