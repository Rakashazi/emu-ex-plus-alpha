...
namespace Base
{
	...
	Window *windowForXWindow(ApplicationContext, ::Window);
	int indexOfScreen(ApplicationContext, Screen &);
...
namespace Input
{
	...
	bool handleXI2GenericEvent(Base::ApplicationContext, Display *, XEvent &);
}
