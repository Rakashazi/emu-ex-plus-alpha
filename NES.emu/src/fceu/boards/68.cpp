...
{
	using namespace Board68;
  info->Power=M68Power;
  info->Close=M68Close;
  GameStateRestore=Board68::StateRestore;
  Board68::WRAMSIZE=8192;
  Board68::WRAM=(uint8*)FCEU_gmalloc(Board68::WRAMSIZE);
  SetupCartPRGMapping(0x10,Board68::WRAM,Board68::WRAMSIZE,1);
  if(info->battery)
  {
    info->SaveGame[0]=Board68::WRAM;
    info->SaveGameLen[0]=Board68::WRAMSIZE;
  }
  AddExState(Board68::WRAM, Board68::WRAMSIZE, 0, "WRAM");
  AddExState(&Board68::StateRegs, ~0, 0, 0);
}
