...
{
	using namespace Board103;
  info->Power=M103Power;
  info->Close=M103Close;
  GameStateRestore=StateRestore;

  WRAMSIZE=16384;
  Board103::WRAM=(uint8*)FCEU_gmalloc(WRAMSIZE);
  SetupCartPRGMapping(0x10,Board103::WRAM,WRAMSIZE,1);
  AddExState(Board103::WRAM, WRAMSIZE, 0, "WRAM");
