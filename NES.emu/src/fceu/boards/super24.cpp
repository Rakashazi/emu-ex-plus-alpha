...
void Super24_Init(CartInfo *info)
{
  ...
  cwrap=Super24CW;
  pwrap=Super24PW;
  BoardSuper24::CHRRAM=(uint8*)FCEU_gmalloc(8192);
  SetupCartCHRMapping(0x10, BoardSuper24::CHRRAM, 8192, 1);
  AddExState(BoardSuper24::CHRRAM, 8192, 0, "CHRR");
