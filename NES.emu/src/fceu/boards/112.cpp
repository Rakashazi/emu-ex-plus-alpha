...
{
	using namespace Board112;
  info->Power=M112Power;
  info->Close=M112Close;
  GameStateRestore=Board112::StateRestore;
  Board112::WRAM=(uint8*)FCEU_gmalloc(8192);
  SetupCartPRGMapping(0x10,Board112::WRAM,8192,1);
  AddExState(Board112::WRAM, 8192, 0, "WRAM");
  AddExState(&Board112::StateRegs, ~0, 0, 0);
}
