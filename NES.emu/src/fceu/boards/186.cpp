...
{
	using namespace Board186;
  info->Power=M186Power;
  info->Close=M186Close;
  GameStateRestore=M186Restore;
  Board186::WRAM=(uint8*)FCEU_gmalloc(32768);
  SetupCartPRGMapping(0x10,Board186::WRAM,32768,1);
  AddExState(Board186::WRAM, 32768, 0, "WRAM");
  AddExState(Board186::StateRegs, ~0, 0, 0);
}
