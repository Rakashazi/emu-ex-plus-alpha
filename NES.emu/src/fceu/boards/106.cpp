...
void Mapper106_Init(CartInfo *info)
{
  ...
  WRAMSIZE=8192;
  Board106::WRAM=(uint8*)FCEU_gmalloc(WRAMSIZE);
  SetupCartPRGMapping(0x10,Board106::WRAM,WRAMSIZE,1);
  AddExState(Board106::WRAM, WRAMSIZE, 0, "WRAM");
