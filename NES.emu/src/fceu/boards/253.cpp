...
{
	using namespace Board253;
  info->Power=M253Power;
  info->Close=M253Close;
  MapIRQHook=M253IRQ;
  GameStateRestore=Board253::StateRestore;

  Board253::CHRRAMSIZE=4096;
  Board253::CHRRAM=(uint8*)FCEU_gmalloc(Board253::CHRRAMSIZE);
  SetupCartCHRMapping(0x10,Board253::CHRRAM,Board253::CHRRAMSIZE,1);
  AddExState(Board253::CHRRAM, Board253::CHRRAMSIZE, 0, "CRAM");

  Board253::WRAMSIZE=8192;
  Board253::WRAM=(uint8*)FCEU_gmalloc(Board253::WRAMSIZE);
  SetupCartPRGMapping(0x10,Board253::WRAM,Board253::WRAMSIZE,1);
  AddExState(Board253::WRAM, Board253::WRAMSIZE, 0, "WRAM");
  if(info->battery)
  {
    info->SaveGame[0]=Board253::WRAM;
    info->SaveGameLen[0]=Board253::WRAMSIZE;
  }

  AddExState(&Board253::StateRegs, ~0, 0, 0);
}
