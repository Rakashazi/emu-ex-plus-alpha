...
namespace BoardGhostbusters63in1
{
...
{
	using namespace BoardGhostbusters63in1;
  ...
  BoardGhostbusters63in1::CHRROM=(uint8*)FCEU_gmalloc(CHRROMSIZE);
  SetupCartPRGMapping(0x10,BoardGhostbusters63in1::CHRROM,CHRROMSIZE,0);
  AddExState(BoardGhostbusters63in1::CHRROM, CHRROMSIZE, 0, "CHRROM");

  GameStateRestore=BoardGhostbusters63in1::StateRestore;
  AddExState(&BoardGhostbusters63in1::StateRegs, ~0, 0, 0);
}
