...
{
	using namespace BoardBMC13in1JY110;
  info->Power=BMC13in1JY110Power;
  AddExState(&BoardBMC13in1JY110::StateRegs, ~0, 0, 0);
  GameStateRestore=BoardBMC13in1JY110::StateRestore;
}
