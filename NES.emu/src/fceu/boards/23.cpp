...
{
	using namespace Board23;
  is23=1;
  info->Power=M23Power;
  info->Close=M23Close;
  MapIRQHook=M23IRQHook;
  GameStateRestore=Board23::StateRestore;

  Board23::WRAMSIZE=8192;
  Board23::WRAM=(uint8*)FCEU_gmalloc(Board23::WRAMSIZE);
  SetupCartPRGMapping(0x10,Board23::WRAM,Board23::WRAMSIZE,1);
  AddExState(Board23::WRAM, Board23::WRAMSIZE, 0, "WRAM");

  AddExState(&Board23::StateRegs, ~0, 0, 0);
}
