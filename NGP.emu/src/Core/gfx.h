...
extern uint8 zbuffer[256];	//Line z-buffer
extern uint16* cfb_scanline;	//set = cfb + (scanline * SCREEN_WIDTH)

extern uint8 scanline;		//Current scanline

extern uint8 winx, winw;
extern uint8 winy, winh;
extern uint8 scroll1x, scroll1y;
extern uint8 scroll2x, scroll2y;
extern uint8 scrollsprx, scrollspry;
extern uint8 planeSwap;
extern uint8 bgc, oowc, negative;
