...
/*************************************************************/
void ExecZ80Cycles(register Z80 *R) __attribute__ ((hot));
word ExecZ80(Z80 *R);
...
void WrZ80(register word Addr,register byte Value) __attribute__ ((hot));
byte RdZ80(register word Addr) __attribute__ ((hot));
...
/************************************ TO BE WRITTEN BY USER **/
void OutZ80(register word Port,register byte Value) __attribute__ ((hot));
byte InZ80(register word Port) __attribute__ ((hot));
